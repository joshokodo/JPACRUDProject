...
<body>
	...
	<c:if test="${detailSearch == true }">
		...
		<form action="descriptionSearch.do" method="POST">
			...
			<input type="text" name="description" /> 
				<input type="submit" name="desciption" value="submit" />
			<hr>
		</form>
	...
	<c:if test="${addBounty == true }">
		...
		<form action="addBounty.do" method="POST">
			...
			<input type="text" name="firstName" pattern=".{3,}" required/> 
			<br> 
			<label for="lastNameSearched">*Last Name</label> 
			<input type="text" name="lastName" pattern=".{3,}" required/> 
			<br>
			<label for="nicknameSearched">Nickname</label> 
			<input type="text" name="nickname" /> 
			<br>
			<label for="description">*Description</label>
			<input type="text" name="description" pattern=".{3,}" required/>
			<br>
			<br>
	...
	<c:if test="${edit == true }">
		...
		<form action="alterBounty.do" method="POST">
			...
			<c:if test="${editBounty.wantedAlive == 89 }">
				<label>Yes</label><input type="radio" name="wantedAlive" value="Y" checked/>
				<label>No</label><input type="radio" name="wantedAlive" value="N" />
